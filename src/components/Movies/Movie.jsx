...
import { FaPlay, FaThumbsUp, FaPlus, FaChevronDown, FaCheck, FaHeart, FaRegHeart } from 'react-icons/fa'
...
const Movie = ({item, type}) => {
  ...
  return (
    ...
    <div className="2xl:w-[280px] xl:w-[280px] lg:w-[280px] md:w-[240px] sm:w-[200px] smler:w-[200px] inline-block relative p-2" onMouseOver={showPopoverDiv} ref={divRef} onMouseLeave={cancelPopOverDiv}>
      <div>
        <img className="w-full h-auto block" src={`https://image.tmdb.org/t/p/w500${item?.backdrop_path}`} alt={item?.title ? item?.title : item?.name} />
      </div>
        ...
        <div className="popOver block" onMouseLeave={hidePopOver}>
          <div className="flex flex-col">
            <div className="w-full h-auto">
              ...
              <img src={`https://image.tmdb.org/t/p/w500${item?.backdrop_path}`} alt={item?.title ? item?.title : item?.name} />
            </div>
