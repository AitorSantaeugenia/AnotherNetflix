...
const LandingPage = () => {
        ...
        <div className="inner-container">
          ...
          <div className="email-form">
            ...
            <div className="get-started">
              <input type="text" name="emailAddress" placeholder="This do nothing." />
  ...
  <section className="border-bottom-hr py-4 mt-20 text-white">
    <div className="qna">
      <button className="accordion" onClick={handleAccordionClick}>What is Netflix</button>
      ...
      <button className="accordion" onClick={handleAccordionClick}>How much does Netflix cost?</button>
      <div className="panel panel-closed">
        <p>
      ...
      <button className="accordion" onClick={handleAccordionClick}>Where can I watch?</button>
        <div className="panel panel-closed">
          <p>
      ...
      <div className="get-started flex justify-center">
        <input type="text" name="" id="" placeholder="This do nothing." />
